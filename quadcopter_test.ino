...
const int channel_1_pin = 35;
const int channel_2_pin = 32;
const int channel_3_pin = 33; 
const int channel_4_pin = 25;
const int channel_5_pin = 26;
const int channel_6_pin = 27;
...
void loop(void) {
  ...
  // MotorInput1 += 15; // Thêm 10 để bù công suất
  // MotorInput4 += 27; // Thêm 10 để bù công suất
  // MotorInput2 -= 5; // Thêm 10 để bù công suất
